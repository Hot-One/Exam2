...
// @Accept json
// @Procedure json
// @Param branch body models.BranchCreate true "BranchCreateRequest"
// @Success 200 {object} Response{data=string} "Success Request"
// @Response 400 {object} Response{data=string} "Bad Request"
// @Failure 500 {object} Response{data=string} "Server error"
func (h *handler) CreateBranch(c *gin.Context) {

	var createBranch models.BranchCreate
...
// @Procedure json
// @Param id path string true "id"
// @Param branch body models.BranchUpdate true "BranchUpdateRequest"
// @Success 200 {object} Response{data=string} "Success Request"
// @Response 400 {object} Response{data=string} "Bad Request"
// @Failure 500 {object} Response{data=string} "Server error"
func (h *handler) UpdateBranch(c *gin.Context) {
	...
	var (
		...
		updateBranch models.BranchUpdate
	)
...
func (h *handler) DeleteBranch(c *gin.Context) {
	...
	rows, err := h.strg.Branch().Delete(c.Request.Context(), &models.BranchPrimaryKey{Id: id})
	if err != nil {
		h.handlerResponse(c, "storage.branch.delete", http.StatusInternalServerError, err.Error())
		return
	}

	h.handlerResponse(c, "create branch resposne", http.StatusNoContent, rows)
}
